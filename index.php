...
<html>
<head>
<title>Launch Page: MCC Shaman Character Generator</title>
...
<body>
	...
	<section>
		...
		<h1><img src="images/title.png" alt="Shaman Character Generator" class="image" /></h1>
		...
		<form action="" id ="shamanForm2"  target="_blank" method="post">
            ...
            <br/>
			  ...
			  <select id="patronAI" name="thePatronAI" class="arifactBox">			
            ...
            <span class="formIputDescription8">Artifact #4:</span>	
			  <select id="artifact4"  name="theArtifact4" class="arifactBox">			
                <option value="0" selected></option>
				<option value="1">Dazer Pistol</option>
				<option value="2">Fazer Pistol</option>
				<option value="3">Gauzer Pistol</option>
            ...
            <span class="formIputDescription2">Weapon #3:</span>
            <input type="text" id="weaponName3"  name="theWeaponName3" value="" class="weaponNameBox">
                
                
            <span class="formIputDescription3">Dmg:</span>
                			  
                <select id="weaponDamage3" name="theWeaponDamage3" class="weaponsDamageBox">			
                <option value="" selected></option>
				<option value="1d3">1d3</option>
				<option value="1d4">1d4</option>
				<option value="1d5">1d5</option>
            ...
            <span class="formIputDescription2">Weapon #4:</span>
            <input type="text" id="weaponName4"  name="theWeaponName4" value="" class="weaponNameBox">
                
                
            <span class="formIputDescription3">Dmg:</span>
                			  
                <select id="weaponDamage4" name="theWeaponDamage4" class="weaponsDamageBox">			
                <option value="" selected></option>
				<option value="1d3">1d3</option>
				<option value="1d4">1d4</option>
				<option value="1d5">1d5</option>
        ...
        $("#generate_characters2").click(function(){
            ...
            $("#shamanForm2").attr('action', "character2/mcc_shaman_"+ $("#level").val() + $("#abilityScores").val() +  ".php");
        });

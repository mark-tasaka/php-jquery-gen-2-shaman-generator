...
<html>
<head>
<title>Gen 2 MCC Shaman Character Generator</title>
...
<script src="https://ajax.googleapis.com/ajax/libs/jquery/3.2.1/jquery.min.js"></script>
	...
	<link rel="stylesheet" type="text/css" href="css/mcc_shaman2.css">
	<link rel="stylesheet" type="text/css" href="css/mcc_shaman_post.css">
...
/*Wetware Program Level 3*/
    ...
    function wetware3Manifest($patronAI)
    {
        ...
        {
            $shamanName = $_POST["theCharacterName"];
...
<!-- JQuery -->
  <img id="character_sheet"/>
   <section>
    ...
    <span id="additionalLanguages"></span>
       ...
       <span id="wetwareLevel"></span>
       
       
       <span id="wetwareProgram1Level"></span>
       <span id="wetwareProgram1Program"></span>
  ...
  <script>
	...
	*/
    ...
    let	intelligence = rollDice(6, 2, 0, 6);
    ...
    let shaman = getShaman();
		...
		let shamanCharacter = {
            ...
            "shamanSkills": shaman.shamanSkillBonus,
            "languages": "Nu-Speak", 
	...
	return shaman[3]; 
       ...
       let imgData = "images/shaman_character_sheet.png";
      ...
      $("#shamanSkills").html(data.shamanSkills);
      ...
      $("#wetwareLevel").html(data.maxWetwareLevel);
